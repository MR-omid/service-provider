...
class Xvfb(object):
    ...
    def __init__(self, width=1024, height=768, colordepth=24, tempdir=None,
                 **kwargs):
        self.width = width
        self.height = height
    ...
    def stop(self):
        return
        # disable stop before process terminate ( because this module used by multiple  external process )
        # termination this process handled by service manager
        # try:
    ...
    def _cleanup_lock_file(self):
        ...
        If you are ending up with /tmp/X123-lock files when Xvfb is nothttps://keep.google.com/#home
